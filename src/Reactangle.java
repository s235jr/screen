public class Reactangle {
    ...
    Reactangle(String points) {
        ...
        this.xCord = Integer.parseInt(reactangle[0]);
        this.yCord = Integer.parseInt(reactangle[1]);
        this.width = Integer.parseInt(reactangle[2]);
        this.heigth = Integer.parseInt(reactangle[3]);
